...
for t = 1:nTr
    ...
    if hasPW
        ...
        tr.alpha_pw_filled = log10(max(powA(t), 1e-12));
        tr.alpha_pw_source = "log_alpha_pow_fallback";
    end

    % BW fill (Hz proxy)
    if hasBW
        tr.alpha_bw_filled = tr.alpha_bw;
        tr.alpha_bw_source = "fooof";
    else
        tr.alpha_bw_filled = bwProxy(t);
        tr.alpha_bw_source = "alpha_sd_proxy";
    end

    fooofOut.trials(t) = tr;
end
