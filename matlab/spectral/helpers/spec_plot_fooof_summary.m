...
% SPEC_PLOT_FOOOF_SUMMARY  Trial-wise FOOOF alpha-peak + fit-quality summary
% V 1.2.0
%
% Covers the periodic component and fit diagnostics in a clean 3x2 layout.
% Aperiodic-specific panels (exponent, offset, PSD fit overlay, flattened
% spectrum) are in the dedicated spec_plot_fooof_aperiodic figure.
%
% Layout (3 rows x 2 cols):
%   [1,1] Aperiodic Exponent over trials
%   [1,2] Aperiodic Offset over trials
%   [2,1] Alpha Peak Center Frequency over trials
%   [2,2] Alpha Peak Power over trials
%   [3,1] Alpha Peak Bandwidth over trials
%   [3,2] Fit Quality (R² and Error) over trials
